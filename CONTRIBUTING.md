...
> [Documentation](https://mslm.io/docs/api/libraries/rust), which may have
> answered your question.

Before you ask a question, it is best to search for existing
[Issues](https://github.com/mslmio/sdk-rust/issues) that might help you. In
...
- Open an [Issue](https://github.com/mslmio/sdk-rust/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g.
  ...
  read the
  [documentation](https://mslm.io/docs/api/libraries/rust). If you
...
- To see if other users have experienced (and potentially already solved) the
  ...
  tracker](https://github.com/mslmio/sdk-rust/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/mslmio/sdk-rust/issues/new). (Since we
...
- Make sure that you are using the latest version.
- Read the [documentation](https://mslm.io/docs/api/libraries/rust) carefully and
  find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/mslmio/sdk-rust/issues) to see if
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/mslmio/sdk-rust/issues).
